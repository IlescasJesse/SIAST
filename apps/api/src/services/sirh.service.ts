...
// Empleados sin mapeo caen en FALLBACK (n3_secretaria)
// ============================================================
...
const DEPT_TO_AREA: Record<string, AreaMapping> = {
  ...
  "DIRECCIóN ADMINISTRATIVA": { areaId: "pb_unidad_administrativa", piso: PisoEdificio.PB },
  "DIRECCIÓN ADMINISTRATIVA. FISCALIA": {
    areaId: "pb_unidad_administrativa",
    piso: PisoEdificio.PB,
  },
  "UNIDAD ADMINISTRATIVA (ARCHIVO)": { areaId: "pb_archivo_general", piso: PisoEdificio.PB },
  TESORERÍA: { areaId: "pb_caja", piso: PisoEdificio.PB },
  TESORERIA: { areaId: "pb_caja", piso: PisoEdificio.PB },
  ...
  "CENTRO INTEGRAL DE ASESORÍA Y ATENCIÓN": {
    areaId: "pb_atencion_ciudadana",
    piso: PisoEdificio.PB,
  },
  "DEPARTAMENTO DE TRAMITACIÓN DE SOLICITUDES": {
    areaId: "pb_atencion_ciudadana",
    piso: PisoEdificio.PB,
  },
  ...
  "DEPARTAMENTO DE ENLACE Y COMUNICACIÓN": {
    areaId: "pb_atencion_ciudadana",
    piso: PisoEdificio.PB,
  },
  "DEPARTAMENTO DE ENLACE Y VERIFICACIÓN": {
    areaId: "pb_atencion_ciudadana",
    piso: PisoEdificio.PB,
  },
  ...
  'COORDINACIÓN DE PROGRAMACIÓN Y CONTROL DE LA INVERSIÓN PÚBLICA "A"': {
    areaId: "n1_subsec_planeacion",
    piso: PisoEdificio.NIVEL_1,
  },
  'COORDINACIÓN DE PROGRAMACIÓN Y CONTROL DE LA INVERSIÓN PÚBLICA "B"': {
    areaId: "n1_subsec_planeacion",
    piso: PisoEdificio.NIVEL_1,
  },
  "DEPARTAMENTO DE ASUNTOS JURÍDICOS": { areaId: "n1_juridico", piso: PisoEdificio.NIVEL_1 },
  "DIRECCIÓN DE NORMATIVIDAD Y ASUNTOS JURÍDICOS": {
    areaId: "n1_juridico",
    piso: PisoEdificio.NIVEL_1,
  },
  ...
  "DEPARTAMENTO DE NORMATIVIDAD Y DESARROLLO METODOLÓGICO": {
    areaId: "n1_juridico",
    piso: PisoEdificio.NIVEL_1,
  },
  ...
  "DEPARTAMENTO DE REGISTRO Y CONTROL DE CRÉDITOS": {
    areaId: "n2_recaudacion",
    piso: PisoEdificio.NIVEL_2,
  },
  ...
  "DEPARTAMENTO DE CONTROL Y EJECUCIÓN DE CRÉDITOS": {
    areaId: "n2_recaudacion",
    piso: PisoEdificio.NIVEL_2,
  },
  "DEPARTAMENTO DE SEGUIMIENTO DE CRÉDITOS": {
    areaId: "n2_recaudacion",
    piso: PisoEdificio.NIVEL_2,
  },
  "DIRECCIÓN DE AUDITORÍA E INSPECCIÓN FISCAL": {
    areaId: "n2_contraloria",
    piso: PisoEdificio.NIVEL_2,
  },
  ...
  "COORDINACIÓN DE PROCESAMIENTO DE CUENTAS POR LIQUIDAR CERTIFICADAS Y SEGUIMIENTO PRESUPUESTARIO A GASTO DE OPERACIÓN":
    { areaId: "n2_egresos", piso: PisoEdificio.NIVEL_2 },
  "COORDINACIÓN DE MONITOREO DEL GASTO": { areaId: "n2_egresos", piso: PisoEdificio.NIVEL_2 },
  "DEPARTAMENTO DE SEGUIMIENTO PRESUPUESTARIO A GASTO DE OPERACIÓN": {
    areaId: "n2_egresos",
    piso: PisoEdificio.NIVEL_2,
  },
  'DEPARTAMENTO DE GESTIÓN PRESUPUESTARIA "A"': {
    areaId: "n2_egresos",
    piso: PisoEdificio.NIVEL_2,
  },
  'DEPARTAMENTO DE GESTIÓN PRESUPUESTARIA "B"': {
    areaId: "n2_egresos",
    piso: PisoEdificio.NIVEL_2,
  },
  ...
  'DEPARTAMENTO DE PROCEMIENTO DE CUENTAS POR LIQUIDAR CERTIFICADAS DE GASTO DE OPERACIÓN "A"': {
    areaId: "n2_egresos",
    piso: PisoEdificio.NIVEL_2,
  },
  'DEPARTAMENTO DE PROCESAMIENTO DE CUENTAS POR LIQUIDAR CERTIFICADAS DE GASTO DE OPERACIÓN "B"': {
    areaId: "n2_egresos",
    piso: PisoEdificio.NIVEL_2,
  },
  "DEPARTAMENTO DE PROCESAMIENTO DE CUENTAS POR LIQUIDAR CERTIFICADAS DE INVERSIÓN PÚBLICA": {
    areaId: "n2_egresos",
    piso: PisoEdificio.NIVEL_2,
  },
  "DEPARTAMENTO DE PROCESAMIENTO Y ANÁLISIS DE LA INFORMACIÓN": {
    areaId: "n2_egresos",
    piso: PisoEdificio.NIVEL_2,
  },
  ...
  "DEPARTAMENTO DE GESTIÓN Y CONTROL DE FORMAS OFICIALES VALORADAS": {
    areaId: "n2_almacen",
    piso: PisoEdificio.NIVEL_2,
  },
};
...
function buildEmpleadoData(emp: SirhEmpleado) {
  ...
  const numEmpleado =
    emp.NUMEMP != null ? parseInt(String(emp.NUMEMP), 10) || undefined : undefined;
...
export async function syncEmpleados(): Promise<void> {
  ...
  console.log(
    `[SIRH] URL: ${process.env.SIRH_BASE_URL ?? "http://localhost:3000"}${SIRH_EMPLOYEES_PATH}`,
  );
...
export async function fetchEmpleadoByRfc(rfc: string): Promise<boolean> {
  ...
  try {
    ...
    if (resp.ok) {
      ...
      console.warn(
        `[SIRH] Error ${resp.status} buscando RFC ${rfcUp} — intentando con plantilla completa`,
      );
    }
  } catch (err) {
    console.warn(
      `[SIRH] Error al buscar RFC ${rfcUp} por endpoint individual:`,
  ...
  try {
    ...
    console.log(
      `[SIRH] RFC ${rfcUp} ${result === "created" ? "importado desde SIRH" : "actualizado desde SIRH"}`,
    );
    return true;
  } catch (err) {
